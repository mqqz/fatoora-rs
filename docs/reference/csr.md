...
## Types
- `CsrProperties` holds the required CSR fields parsed from a properties file (common name, serial
  number, org identifiers, country, invoice type, location, business category). It validates
  non-empty fields and country code format.
